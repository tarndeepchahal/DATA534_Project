...
# This function returns a list containing the video Id and the number of views on a given video
get_views <- function (urlInput=NULL) {
  ...
  # Return a list containing the video ID and the number of views
